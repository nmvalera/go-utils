...
func TestViperConfig(t *testing.T) {
	...
	v.Set("mainEp.http.writeTimeout", "42s")
	v.Set("mainEp.http.idleTimeout", "43s")
	v.Set("mainEp.net.keepAlive", "44s")
	v.Set("mainEp.net.keepAliveProbe.enable", "true")
	v.Set("mainEp.net.keepAliveProbe.idle", "45s")
	v.Set("mainEp.net.keepAliveProbe.interval", "46s")
	v.Set("mainEp.net.keepAliveProbe.count", "47")
	v.Set("mainEp.http.maxHeaderBytes", "40000")
	v.Set("healthzEp.addr", "localhost:8882")
	v.Set("healthzEp.http.readTimeout", "50s")
	v.Set("healthzEp.http.readHeaderTimeout", "51s")
	v.Set("healthzEp.http.writeTimeout", "52s")
	v.Set("healthzEp.http.idleTimeout", "53s")
	v.Set("healthzEp.net.keepAlive", "54s")
	v.Set("healthzEp.net.keepAliveProbe.enable", "true")
	v.Set("healthzEp.net.keepAliveProbe.idle", "55s")
	v.Set("healthzEp.net.keepAliveProbe.interval", "56s")
	v.Set("healthzEp.net.keepAliveProbe.count", "57")
	v.Set("healthzEp.http.maxHeaderBytes", "50000")
	v.Set("log.level", "info")
	v.Set("startTimeout", "10s")
	v.Set("stopTimeout", "20s")
