...
func (app *App) MainEntrypoint() *kkrthttp.EntrypointConfig {
	return app.cfg.MainEntrypoint
}

func (app *App) HealthzEntrypoint() *kkrthttp.EntrypointConfig {
	return app.cfg.HealthzEntrypoint
}
