...
var (
	logLevelFlag = &spf13.StringFlag{
		...
		DefaultValue: defaultConfig.Level,
	}
	logFormatFlag = &spf13.StringFlag{
		ViperKey:     "log.format",
		Name:         "log-format",
		Env:          "LOG_FORMAT",
		Description:  fmt.Sprintf("Log formatter (one of %q)", formatsStr),
		DefaultValue: defaultConfig.Format,
	}
	logEnableStacktraceFlag = &spf13.BoolFlag{
		...
		DefaultValue: defaultConfig.EnableStacktrace,
	}
	logEnableCallerFlag = &spf13.BoolFlag{
		...
		DefaultValue: defaultConfig.EnableCaller,
	}
	logEncoderMessageKeyFlag = &spf13.StringFlag{
		...
		DefaultValue: defaultConfig.Encoder.MessageKey,
	}
	logEncoderLevelKeyFlag = &spf13.StringFlag{
		...
		DefaultValue: defaultConfig.Encoder.LevelKey,
	}
	logEncoderTimeKeyFlag = &spf13.StringFlag{
		...
		DefaultValue: defaultConfig.Encoder.TimeKey,
	}
	logEncoderNameKeyFlag = &spf13.StringFlag{
		...
		DefaultValue: defaultConfig.Encoder.NameKey,
	}
	logEncoderCallerKeyFlag = &spf13.StringFlag{
		...
		DefaultValue: defaultConfig.Encoder.CallerKey,
	}
	logEncoderFunctionKeyFlag = &spf13.StringFlag{
		...
		DefaultValue: defaultConfig.Encoder.FunctionKey,
	}
	logEncoderStacktraceKeyFlag = &spf13.StringFlag{
		...
		DefaultValue: defaultConfig.Encoder.StacktraceKey,
	}
	logEncoderSkipLineEndingFlag = &spf13.BoolFlag{
		...
		DefaultValue: defaultConfig.Encoder.SkipLineEnding,
	}
	logEncoderLineEndingFlag = &spf13.StringFlag{
		...
		DefaultValue: defaultConfig.Encoder.LineEnding,
	}
	logEncoderLevelEncoderFlag = &spf13.StringFlag{
		...
		DefaultValue: defaultConfig.Encoder.LevelEncoder,
	}
	logEncoderTimeEncoderFlag = &spf13.StringFlag{
		...
		DefaultValue: defaultConfig.Encoder.TimeEncoder,
	}
	logEncoderDurationEncoderFlag = &spf13.StringFlag{
		...
		DefaultValue: defaultConfig.Encoder.DurationEncoder,
	}
	logEncoderCallerEncoderFlag = &spf13.StringFlag{
		...
		DefaultValue: defaultConfig.Encoder.CallerEncoder,
	}
	logEncoderNameEncoderFlag = &spf13.StringFlag{
		...
		DefaultValue: defaultConfig.Encoder.NameEncoder,
	}
	logEncoderConsoleSeparatorFlag = &spf13.StringFlag{
		...
		DefaultValue: defaultConfig.Encoder.ConsoleSeparator,
	}
	logSamplingInitialFlag = &spf13.IntFlag{
		...
		DefaultValue: defaultConfig.Sampling.Initial,
	}
	logSamplingThereafterFlag = &spf13.IntFlag{
		...
		DefaultValue: defaultConfig.Sampling.Thereafter,
	}
	logOutputPathsFlag = &spf13.StringArrayFlag{
		...
		DefaultValue: common.ValSlice(*defaultConfig.OutputPaths...),
	}
	logErrorOutputPathsFlag = &spf13.StringArrayFlag{
		...
		DefaultValue: common.ValSlice(*defaultConfig.ErrorOutputPaths...),
	}
)

func AddFlags(v *viper.Viper, f *pflag.FlagSet) {
	logLevelFlag.Add(v, f)
	logFormatFlag.Add(v, f)
