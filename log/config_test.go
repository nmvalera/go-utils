...
func TestViperConfig(t *testing.T) {
	...
	v.Set("log.enableStacktrace", true)
	v.Set("log.enableCaller", true)
	v.Set("log.encoding.messageKey", "msg")
	v.Set("log.encoding.levelKey", "level")
	v.Set("log.encoding.timeKey", "time")
	v.Set("log.encoding.nameKey", "logger")
	v.Set("log.encoding.callerKey", "caller")
	v.Set("log.encoding.functionKey", "function")
	v.Set("log.encoding.stacktraceKey", "stacktrace")
	v.Set("log.encoding.skipLineEnding", false)
	v.Set("log.encoding.lineEnding", "\n")
	v.Set("log.encoding.levelEncoder", "capitalColor")
	v.Set("log.encoding.timeEncoder", "rfc3339")
	v.Set("log.encoding.durationEncoder", "s")
	v.Set("log.encoding.callerEncoder", "short")
	v.Set("log.encoding.nameEncoder", "full")
	v.Set("log.encoding.consoleSeparator", "\t")
	v.Set("log.sampling.initial", 100)
	v.Set("log.sampling.thereafter", 100)
	v.Set("log.outputPaths", []string{"stderr"})
	v.Set("log.errorOutputPaths", []string{"stderr"})
